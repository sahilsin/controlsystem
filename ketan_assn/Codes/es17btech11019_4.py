...
num=[k*t, k]
den=[0.6,9.9, 59.8, 159.6, 173.6, 48, 0]
# num=[t,1]
# den=[t*a,1]
...
# if using termux
plt.savefig('./figs/es17btech11019_5.pdf')
plt.savefig('./figs/es17btech11019_5.eps')
subprocess.run(shlex.split("termux-open ./figs/es17btech11019_5.pdf"))
